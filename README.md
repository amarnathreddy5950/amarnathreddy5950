<!--
  ...
  1. Create a new public repo named EXACTLY: amarnathreddy5950
     (a repo named the same as your username becomes your profile page)
  2. Add this file as README.md in that repo.
  3. Commit. It will render at https://github.com/amarnathreddy5950
  4. Edit the placeholders marked "TODO" (portfolio URL, project links).
-->

<h1 align="center">Hi, I'm Amarnath 👋</h1>

<p align="center">
  <b>Software Development Engineer @ AWS</b> · building production AI agents.
</p>
...
### What I work on
- **AI / LLM:** AI agents and multi-agent orchestration, Amazon Bedrock (Claude), prompt engineering, RAG, LLM-as-judge evaluation
- **Infrastructure:** AWS CDK (TypeScript), Step Functions, Lambda (Kotlin/Python), DynamoDB, SQS, EventBridge
- **Operations:** multi-region deployment, observability, load testing, game days, auto-rollback
